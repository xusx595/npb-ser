...
#define nx2 (PROBLEM_SIZE-2)
#define ny2 (PROBLEM_SIZE-2)
...
/* common /work_1d/ */
extern align(32) double cv  [PROBLEM_SIZE];
extern align(32) double rhon[PROBLEM_SIZE];
extern align(32) double rhos[PROBLEM_SIZE];
extern align(32) double rhoq[PROBLEM_SIZE];
extern align(32) double cuf [PROBLEM_SIZE];
extern align(32) double q   [PROBLEM_SIZE];
extern align(32) double ue1 [PROBLEM_SIZE];
extern align(32) double ue [PROBLEM_SIZE][4];
extern align(32) double buf1[PROBLEM_SIZE];
